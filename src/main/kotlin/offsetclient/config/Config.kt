...
import offsetclient.ui.BlockAnimationBlacklist
import offsetclient.ui.HideModID
import java.awt.Color
import java.io.File
import java.util.function.Consumer

object Config : Vigilant(File("./config/offsetclient/config.toml"), "OffsetClient", sortingBehavior = Sorting) {
