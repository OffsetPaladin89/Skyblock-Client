...
import offsetclient.OffsetClient
import offsetclient.OffsetClient.Companion.configData
import offsetclient.config.ConfigManager.parseData
import offsetclient.config.ConfigManager.writeConfig
import offsetclient.features.NoBlockAnimation.blacklist
...
class BlockAnimationBlacklist : WindowScreen(newGuiScale = GuiScale.scaleForScreenSize().ordinal) {
    ...
    override fun onScreenClose() {
        ...
        parseData()
        OffsetClient.configFile?.let { writeConfig(it) }
    }
}
